...
class PodcastsViewController: UIViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        URLRequest.top100RSS(urlString: URL.iTunesRSSAPI.top100RSSPodcasts.rawValue) { (rssFeed) in
