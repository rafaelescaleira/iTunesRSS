...
class TVShowsViewController: UIViewController, UISearchResultsUpdating {
    ...
    override func viewDidLoad() {
        ...
        URLRequest.top100RSS(urlString: URL.iTunesRSSAPI.top100RSSTVShows.rawValue) { (rssFeed) in
